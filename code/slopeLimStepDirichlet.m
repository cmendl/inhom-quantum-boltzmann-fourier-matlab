function Un1 = slopeLimStepDirichlet(h,k,A,Un)
%SLOPELIMSTEPDIRICHLET - Numerically solve u_t + A u_x = 0 with Dirichlet boundary conditions using a slope limiter method
%
%    Un1 = SLOPELIMSTEPDIRICHLET(h,k,A,Un)
%
...
% and run standard slope limiter step
Un1 = slopeLimStep(h,k,A,[Un(:,1),Un,Un(:,end)]);
